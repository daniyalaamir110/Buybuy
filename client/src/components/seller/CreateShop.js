...
const CreateShop = () => {
  ...
  const cancelImage = () => imageRef.current.src = "";
      ...
      axios.post("/api/create-shop", {
        ...
        if (res.data.success) {
          ...
          if (shopLogo) {
            ...
            axios.post("/api/change-shop-logo?shopId=" + res.data.shopId, formData, config);
          }
        } else if (res.data.error) {
          swal({
            title: "Oops!",
            text: "Your shop could not be created",
            icon: "error",
            button: "OK",
          });
        }
  ...
  return (
    <div className="content bg-light">
      <Sidebar />
      <h1 className="display-4 my-2 text-center">Setup A New Shop</h1>
          ...
          <div className="row bg-white p-3 m-3 border">
            ...
            <div className="col-lg-4 mx-auto">
              ...
              <div className="uploaded-image">
                <img ref={imageRef} alt="No shop logo" />
              </div>
